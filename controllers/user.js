...
exports.postReset = function(req, res, next) {
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'support@wayfairer.co',
        subject: 'Your Wayfairer password has been changed',
        text: 'Hello,\n\n' +
...
exports.postForgot = function(req, res, next) {
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'support@wayfairer.cp',
        subject: 'Reset your password on Wayfairer',
...
exports.postUpdatePublicProfile = function(req, res, next) {
  User.findById(req.user.id, function(err, user) {
    if (err) return next(err);
    user.profile.gender = req.body.gender || '';
    user.profile.location = req.body.location || '';
    ...
    user.profile.role.culturalMediator = req.body.roleCulturalMediator || false;
    user.profile.role.culturalArtOrganisation = req.body.roleCulturalArtOrganisation || false;
...
exports.postUpdateAccountProfile = function(req, res, next) {
  User.findById(req.user.id, function(err, user) {
    if (err) return next(err);
