...
var basicPageController = require('./controllers/basic-page');
...
app.get('/wayfairer-signup', userController.getSignupWayfairer);
app.post('/signup', userController.postSignup);
app.post('/wayfairer-signup', userController.postSignup);
app.get('/contact', contactController.getContact);
app.post('/contact', contactController.postContact);
app.get('/account', passportConf.isAuthenticated, userController.getAccount);
app.post('/account/profile', passportConf.isAuthenticated, userController.postUpdateAccountProfile);
